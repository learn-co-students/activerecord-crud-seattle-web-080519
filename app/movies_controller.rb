...
def can_be_found_updated_and_saved
  ...
  lets_update = Movie.find_by(title: "Awesome Flick")
  lets_update.title = "Even Awesomer Flick"
  lets_update.save
end
...
def can_destroy_a_single_item
  ...
  find = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  find.delete
end
