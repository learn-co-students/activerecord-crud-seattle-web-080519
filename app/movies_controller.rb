...
def can_be_instantiated_and_then_saved
  ...
  movie.release_date = "This is a release date."
  movie.director = "This is a director"
  movie.lead = "This is the lead"
  movie.in_theaters = "This is to see if it is in theaters or not"
  movie.save
end
...
def can_be_found_updated_and_saved
  ...
  specific = Movie.find_by(title:"Awesome Flick")

  specific.update(title: "Even Awesomer Flick")
  specific.save
end
